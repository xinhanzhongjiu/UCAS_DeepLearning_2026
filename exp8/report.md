...
开发与运行环境：conda 环境 `yolo`，PyTorch 2.6 + CUDA。
...
![海滩场景](results/vis/sample_000.png)
...
![船与海滩](results/vis/sample_001.png)
...
![笔记本场景](results/vis/sample_002.png)
...
![建筑前人群](results/vis/sample_005.png)
